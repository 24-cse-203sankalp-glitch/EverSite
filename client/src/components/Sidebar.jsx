...
export default function Sidebar({ activeSection, onSectionChange, onOpenChat, darkMode }) {
  return (
    <aside className="w-64 bg-white dark:bg-black border-r border-gray-200 dark:border-gray-800 h-[calc(100vh-73px)] sticky top-[73px] overflow-y-auto transition-colors">
      <nav className="p-4 space-y-1">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-800">
          ...
          <button
            onClick={onOpenChat}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
          >
